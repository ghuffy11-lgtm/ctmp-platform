...
FROM (VALUES
    ...
    ('vendor:invite',                'vendor', 'Invite a prospective supplier to register on the vendor portal.'),
    -- tender
...
WITH grants(role_code, permission_code) AS (
    ...
    ('PROCUREMENT_ADMIN', 'vendor:invite'),
    ...
    ('PROCUREMENT_OFFICER', 'vendor:invite'),
