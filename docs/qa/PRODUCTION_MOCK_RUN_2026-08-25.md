...
### 2. Vendor page advertised a public reply option that does not exist — FIXED

Private replies are the intended design (owner, 2026-08-25) and the behaviour is correct;
`clarifications.service.ts:266` hardcodes `isPublic: false`. Only the vendor-facing copy was wrong,
promising *"replies marked as public are visible to all bidders"*. Reworded to *"The reply goes only
to you."* Not yet deployed — needs a `web-vendor` rebuild.

Rationale in `docs/decisions/DECISION_LOG.md` (2026-08-25).
